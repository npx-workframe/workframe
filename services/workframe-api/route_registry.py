...
ROUTES: tuple[Route, ...] = (
    ...
    Route("GET", "/api/auth/hermes-dashboard-gate", AuthLevel.PUBLIC, "_route_get_auth_hermes_dashboard_gate"),
    Route("GET", "/api/auth/google/callback", AuthLevel.PUBLIC, "_route_get_auth_google_callback"),
    ...
    Route("POST", "/api/admin/vault/init", AuthLevel.ROLE_OWNER_ADMIN, "_route_post_admin_vault_init"),
    Route("POST", "/api/admin/vault/unlock", AuthLevel.ROLE_OWNER_ADMIN, "_route_post_admin_vault_unlock"),
    Route("POST", "/api/admin/vault/seal", AuthLevel.ROLE_OWNER_ADMIN, "_route_post_admin_vault_seal"),
...
_ROUTE_PATTERNS_RAW: tuple[tuple, ...] = (
    ...
    ("GET", r"^/api/rooms/[^/]+/live$", "/api/rooms/{id}/live", AuthLevel.SESSION, False, False, "_route_pattern_get_room_live"),
    ("GET", r"^/api/rooms/[^/]+/activity$", "/api/rooms/{id}/activity", AuthLevel.SESSION, False, False, "_route_pattern_get_room_activity"),
    ("GET", r"^/api/workspace/[^/]+/activity$", "/api/workspace/{id}/activity", AuthLevel.SESSION, False, False, "_route_pattern_get_workspace_activity"),
    ("GET", r"^/api/workspace/[^/]+/kanban/tasks$", "/api/workspace/{id}/kanban/tasks", AuthLevel.SESSION, False, False, "_route_pattern_get_workspace_kanban_tasks"),
    ("GET", r"^/api/workspace/[^/]+/delegation-grants$", "/api/workspace/{id}/delegation-grants", AuthLevel.SESSION, False, False, "_route_pattern_get_workspace_delegation_grants"),
    ("GET", r"^/api/rooms/[^/]+/sessions$", "/api/rooms/{id}/sessions", AuthLevel.SESSION, False, False, "_route_pattern_get_room_sessions"),
    ("GET", r"^/api/workspace/[^/]+/invites$", "/api/workspace/{id}/invites", AuthLevel.SESSION, False, False, "_route_pattern_get_workspace_invites"),
    ("GET", r"^/api/invites/[^/]+$", "/api/invites/{token}", AuthLevel.SESSION, False, False, "_route_pattern_get_invite"),
    ("GET", r"^/api/workspace/[^/]+/members$", "/api/workspace/{id}/members", AuthLevel.SESSION, False, False, "_route_pattern_get_workspace_members"),
    ("GET", r"^/api/workspace/[^/]+/memory$", "/api/workspace/{id}/memory", AuthLevel.SESSION, False, False, "_route_pattern_get_workspace_memory"),
    ("GET", r"^/api/workspace/[^/]+/budget$", "/api/workspace/{id}/budget", AuthLevel.SESSION, False, False, "_route_pattern_get_workspace_budget"),
    ("GET", r"^/api/workspace/[^/]+/grants$", "/api/workspace/{id}/grants", AuthLevel.SESSION, False, False, "_route_pattern_get_workspace_grants"),
    ("GET", r"^/api/rooms/[^/]+/messages$", "/api/rooms/{id}/messages", AuthLevel.SESSION, False, False, "_route_pattern_get_room_messages"),
    ("GET", r"^/api/workspace/[^/]+/events$", "/api/workspace/{id}/events", AuthLevel.SESSION, False, False, "_route_pattern_get_workspace_events"),
    ("GET", r"^/api/me/oauth/[^/]+/status$", "/api/me/oauth/{provider}/status", AuthLevel.SESSION, False, False, "_route_pattern_get_me_oauth_status"),
    ...
    ("GET", r"^/api/workspace/[^/]+/credentials$", "/api/workspace/{id}/credentials", AuthLevel.SESSION, False, False, "_route_pattern_get_workspace_credentials"),
    ("GET", r"^/api/agents/[^/]+/credentials$", "/api/agents/{id}/credentials", AuthLevel.SESSION, False, False, "_route_pattern_get_agent_credentials"),
    ("POST", r"^/api/me/oauth/[^/]+/start$", "/api/me/oauth/{provider}/start", AuthLevel.SESSION, False, False, "_route_pattern_post_me_oauth_start"),
    ("POST", r"^/api/me/providers/[^/]+/disconnect$", "/api/me/providers/{id}/disconnect", AuthLevel.SESSION, False, False, "_route_pattern_post_me_providers_disconnect"),
    ("POST", r"^/api/workspace/[^/]+/credentials/store$", "/api/workspace/{id}/credentials/store", AuthLevel.SESSION, False, False, "_route_pattern_post_workspace_credentials_store"),
    ("POST", r"^/api/workspace/[^/]+/credentials/[^/]+/revoke$", "/api/workspace/{id}/credentials/{cid}/revoke", AuthLevel.SESSION, False, False, "_route_pattern_post_workspace_credentials_revoke"),
    ("POST", r"^/api/workspace/[^/]+/rooms$", "/api/workspace/{id}/rooms", AuthLevel.SESSION, False, False, "_route_pattern_post_workspace_rooms"),
    ("POST", r"^/api/workspace/[^/]+/rooms/create$", "/api/workspace/{id}/rooms/create", AuthLevel.SESSION, False, False, "_route_pattern_post_workspace_rooms_create"),
    ...
    ("POST", r"^/api/workspace/[^/]+/members$", "/api/workspace/{id}/members", AuthLevel.SESSION, False, False, "_route_pattern_post_workspace_members"),
    ("POST", r"^/api/workspace/[^/]+/kanban/tasks$", "/api/workspace/{id}/kanban/tasks", AuthLevel.SESSION, False, False, "_route_pattern_post_workspace_kanban_tasks"),
    ("POST", r"^/api/workspace/[^/]+/delegation-grants$", "/api/workspace/{id}/delegation-grants", AuthLevel.SESSION, False, False, "_route_pattern_post_workspace_delegation_grants"),
    ("POST", r"^/api/workspace/[^/]+/runtime-profiles/purge$", "/api/workspace/{id}/runtime-profiles/purge", AuthLevel.SESSION, False, False, "_route_pattern_post_workspace_runtime_profiles_purge"),
    ("POST", r"^/api/workspace/[^/]+/memory$", "/api/workspace/{id}/memory", AuthLevel.SESSION, False, False, "_route_pattern_post_workspace_memory"),
    ("POST", r"^/api/memory/[^/]+$", "/api/memory/{id}", AuthLevel.SESSION, False, False, "_route_pattern_post_memory"),
    ("POST", r"^/api/workspace/[^/]+/budget$", "/api/workspace/{id}/budget", AuthLevel.SESSION, False, False, "_route_pattern_post_workspace_budget"),
