...
const steps = [
  ['-m', 'py_compile', 'server.py', 'zk_auth.py', 'email_sender.py', 'profile_config_yaml.py', 'route_registry.py', 'auth_gate.py', 'user_prefs.py', 'rooms.py', 'kanban_cron.py', 'hermes_profiles.py', 'profile_gateway.py', 'model_surface.py', 'provider_bootstrap.py', 'db_schema.py', 'workspace_files.py', 'activity_feed.py', 'crew_registry.py', 'health_monitor.py', 'snapshot_feed.py', 'run_surface_wiring.py', 'run_authority.py', 'run_ledger.py', 'domain/entities.py', 'domain/__init__.py'],
