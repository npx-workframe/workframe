...
| `npx create-workframe@0.1.27 MyProject` | Scaffold a complete Workframe + Hermes project cell. | UI, API, supervisor, Docker Compose, project files, profiles, and guided onboarding. |
